...
<script>
	(function($) {
		var app = $.sammy('#add', function() {
			...
			this.get('#/loginClient', function(context) {
				this.partial('clientLogin.jsp')
			});
			this.get('#/listItems', function(context) {
	...
	<ul class="nav nav-tabs">
		...
		<!-- <li class="dropdown"><a class="dropdown-toggle" 
			...
			<ul class="dropdown-menu">
				...
				<li><a href="#/exchange">Exchange Item</a></li>
			</ul></li> -->
		...
		<!-- <li class="dropdown"><a class="dropdown-toggle"
		 ...
		 <li class="dropdown"><a class="dropdown-toggle"
			data-toggle="dropdown" href="#"> <img src="resources/images/login.png" alt="logo">Register/login <span
				class="caret"></span>
		</a>
			<ul class="dropdown-menu">
